...
<div class="container">
  <div class="my-5 border-bottom border-info text-info">
    ...
    <h5 class="mt-3">Εγγραφή Φοιτητή</h5>
  </div>
  <div>
    <?php
      ...
      if ($user->isStudent()) {
        ...
        try {
          if ($student->isRegistered()) {
            echo '<div class="content-section">
                    <h3>Έχετε κάνει ήδη κάνει εγγραφή στο σύστημα</h3>
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
              if (isset($_POST['email'])) {
                ...
                echo '<div class="content-section">
                        ...
                        <div class="border-top pt-3">
                          <small class="text-muted">
                            Πατήστε <a href="index.php">εδώ</a> για να επιστρέψετε στην αρχική σελίδα και να ολοκληρώσετε την διαδικασία υποβολής των δικαιολογητικών.
                          </small>
                        </div>
                      </div>';
              } else {
                ...
                echo '<div class="content-section">
                        ...
                        <div class="border-top pt-3">
                          <small class="text-muted">
                            Πατήστε <a href="register.php">εδώ</a> για να δοκιμάσετε ξανά ή <a href="index.php">εδώ</a> για να επιστρέψετε στην αρχική σελίδα.
                          </small>
                        </div>
                      </div>';
              }
              ...
              $user->showMessage('warning','Προειδοποίηση!','Η εγγραφή σας είναι απαραίτητη για την ηλεκτρονική υποβολή των δικαιολογητικών σας στο Γραφείο Πρακτική Άσκησης');
            }
          }
        } catch(Exception $e) {
          echo '<div class="content-section">
                          <h3>Αποτυχία Εγγραφής</h3>
                          <div class="border-top pt-3">
                            <p>'.$e->getMessage().'</p>
        ...
        $user->showMessage('danger','Σφάλμα!','Εγγραφή μπορούν να κάνουν μόνο φοιτητές οι οποίοι πρόκειται να παρακολουθήσουν το μάθημα της Πρακτικής Άσκησης.');
      }
    ?>
  </div>
</div>
